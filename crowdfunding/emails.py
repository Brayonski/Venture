...
def send_approval_request_email(campaign_name,campaign_id,subject, from_email, to):
    ...
    html_content = '<p>Campaign ' + campaign_name + ' has been created and is pending approval</p><p>Click <a href="http://127.0.0.1:8000/admin/crowdfunding/campaign/' + str(
...
def send_campaign_disbursement_email(campaign_name,campaign_id,subject, from_email, to, status):
    ...
    html_content = '<p>Campaign ' + campaign_name + ' has been closed and is pending approval for '+status+'</p><p>Click <a href="http://127.0.0.1:8000/admin/crowdfunding/campaigndisbursement/' + str(
