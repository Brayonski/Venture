...
def send_approval_request_email(campaign_name,campaign_id,subject, from_email, to):
    ...
    html_content = '<p>Campaign ' + campaign_name + ' has been created and is pending approval</p><p>Click <a href="http://52.37.84.193:8081/admin/crowdfunding/campaign/' + str(
...
def send_actioned_campaign_email(campaign_name,campaign_id,subject, from_email, to, status):
    ...
    html_content = '<p>Campaign ' + campaign_name + ' has been '+status+'</p><p>Click <a href="http://52.37.84.193:8081/crowdfunding/business/' + str(
...
def send_campaign_disbursement_email(campaign_name,campaign_id,subject, from_email, to, status):
    ...
    html_content = '<p>Campaign ' + campaign_name + ' has been closed and is pending approval for '+status+'</p><p>Click <a href="http://52.37.84.193:8081/admin/crowdfunding/campaigndisbursement/' + str(
