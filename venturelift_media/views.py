...
class HomeView(ListView):
    ...
    def get_context_categories(self):
        ...
        if current_url == 'media_videos':
            context['visual'] = AudioVisual.objects.filter(category='Video', sub_category__title__iexact=category)
        elif current_url == 'media_podcast':
            context['audio'] = AudioVisual.objects.filter(category='Podcast', sub_category__title__iexact=category)
        else:
